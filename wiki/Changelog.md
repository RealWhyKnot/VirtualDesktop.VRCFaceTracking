...
All notable user-visible changes to VirtualDesktop.VRCFaceTracking. Mirrors the root CHANGELOG.md and is mirrored into the GitHub Wiki by .github/workflows/wiki-sync.yml.
