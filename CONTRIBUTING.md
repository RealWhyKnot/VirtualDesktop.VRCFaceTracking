...
Thanks for helping improve VirtualDesktop.VRCFaceTracking. Keep changes focused and easy to review.
...
- Run dotnet build or the module-specific build command before opening a PR.
